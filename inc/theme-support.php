...
add_action( 'after_setup_theme', 'pixels_register_nav_menu' );
...
function pixels_posted_footer(){
	...
	if( comments_open() ){
		...
		$comments = '<a class="comments-link" href="' . get_comments_link() . '">'. $comments .' <span class="pixels-icon pixels-comment"></span></a>';
	} else {
